  ...
  return (
    <div className='bg-white' style={{minHeight:"670px"}}>
      <div>
        ...
        <p data-v-b6ad2e88="" class="desc text-center">لتسجيل الدخول أضف رقم جوالك ادناه ، وسيتم ارسال <br /> رسالة نصية للتحقق من الرقم المضاف ..</p>
      </div>
      <div className=' flex justify-center'>
        <div className="relative mt-2.5">
          <div data-v-b6ad2e88="" dir="ltr" class="form-group row short flex-row mb-0 flex justify-center">
            <div data-v-b6ad2e88="" class="col col-4 col-md-3">
              <select data-v-b6ad2e88="" required="required" class="form-control" style={{ textAlign: " left", direction: "ltr" }}>
            ...
            <div data-v-b6ad2e88="" class="col col-8 col-md-9 position-relative mb-2">
              <input data-v-b6ad2e88="" id="mobile" autofocus="autofocus" type="tel" required="required" placeholder="5xxxxxxxx" class="phone form-control mb-0" />
            </div>
          </div>
        </div>
      </div>
